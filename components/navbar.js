...
export default function Navbar() {
    function openMobileMenu() {
        ...
        btn.classList.toggle("text-yellow-200");
    }
    ...
    return (
        <>
            <nav className={`sticky top-0 z-50 ${styles.did_normal_font} items-center py-2 bg-yellow-200 sticky`}>
                {/* pc menu */}
                <div className={`flex justify-between items-center px-3 text-lg 2xl:text-xl`}>
                    <div className="flex">
                        <Link href="/">
                        ...
                        <Link href="/koleksi">
                            <a className="hidden sm:flex px-3 py-1 2xl:py-2 mx-1 2xl:mx-2 rounded-md hover:bg-black hover:text-yellow-200 transition duration-150">
                                Koleksi
                            </a>
                        </Link>
                        <a href="https://forms.gle/capcMNwPAD7ebwxs7" target="_blank" className="hidden sm:flex px-3 py-1 2xl:py-2 mx-1 2xl:mx-2 rounded-md hover:bg-black hover:text-yellow-200 transition duration-150">
                            Daftar
                        </a>
                    </div>
                    
                    {/* mobile menu btn */}
                    <div id="mobile-menu-btn" className="flex sm:hidden px-2 py-1 rounded-md hover:bg-black hover:text-yellow-200 transition duration-150">
